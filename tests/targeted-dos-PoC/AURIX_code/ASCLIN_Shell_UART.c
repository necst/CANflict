...
void printInfo(IfxStdIf_DPipe *io)
{
    ...
    IfxStdIf_DPipe_print(io, "\\_   ___ \\   /  _  \\   \\      \\______   \\ /  _  \\  /   _____//   _____/\n\r");
    IfxStdIf_DPipe_print(io, "/    \\  \\/  /  /_\\  \\  /   |   \\|     ___/  /_\\  \\ \\_____  \\ \\_____  \\ \n\r");
    IfxStdIf_DPipe_print(io, "\\     \\____/    |    \\/    |    \\    |  /    |    \\/        \\/        \\\n\r");
    IfxStdIf_DPipe_print(io, " \\______  /\\____|__  /\\____|__  /____|  \\____|__  /_______  /_______  /\n\r");
    IfxStdIf_DPipe_print(io, "        \\/         \\/         \\/                \\/        \\/        \\/ \n\r\n\r");
    // clang-format on
}
...
IfxStdIf_DPipe* initShellInterface(void)
{
